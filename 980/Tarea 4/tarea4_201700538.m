...
% Caso 4: Graficar espectro de frecuencia
case 4
  ...
  try
    ...
    ventana = hann(floor(N/4)); % Ventana de Hann (de tamaño menor a N)
    % Densidad espectral de potencia usando pwelch
    [Sxx, f] = pwelch(audio, ventana, [], [], FS);
    % Gráfica el espectro de frecuencia en dB
    plot(f, 10*log10(Sxx));
